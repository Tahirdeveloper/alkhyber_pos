<?php $__env->startSection('title', 'Make Purchase'); ?>
...
unset($__errorArgs, $__bag); ?>" id="kg" placeholder="KG" value="<?php echo e(old('kg')); ?>">
                            <?php $__errorArgs = ['kg'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="bag" placeholder="Quantity" value="<?php echo e(old('quantity', 1)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="short" placeholder="Short" value="<?php echo e(old('short')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="netWeight" placeholder="Net Weight" value="<?php echo e(old('short')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="kgDiscount" placeholder="00" value="<?php echo e(old('kgDiscount')); ?>">
                            <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="hidden" name="allTotal" class="form-control <?php $__errorArgs = ['purchase_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> purchase_price" id="purchase_price" placeholder="Purchase price" value="<?php echo e(old('purchase_price')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="profit" placeholder="profit" value="<?php echo e(old('profit')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="tax" placeholder="Tax & Expanses" value="<?php echo e(old('tax')); ?>">
                            <?php $__errorArgs = ['tax'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="sale_price" placeholder="sale price" value="<?php echo e(old('sale_price')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="grossTotal" placeholder="00" value="<?php echo e(old('grossTotal')); ?>" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Point Of Sale\Alkhyber_POS\resources\views/purchase/create.blade.php ENDPATH**/ ?>