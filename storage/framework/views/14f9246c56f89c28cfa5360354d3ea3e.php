...
unset($__errorArgs, $__bag); ?>" id="quantity" placeholder="Quantity" value="<?php echo e(old('stock', $product->stock)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="pur_price" placeholder="Purchase price" value="<?php echo e(old('purchase_price',$product->purchase_price)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="Tax/Expenses" placeholder="Tax & Expanses" value="<?php echo e(old('tax',$product->tax)); ?>">
                                <?php $__errorArgs = ['tax'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Point Of Sale\POS\resources\views/products/edit.blade.php ENDPATH**/ ?>