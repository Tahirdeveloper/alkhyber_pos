    ...
    <div class="card-body">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td><img class="product-img" src="<?php echo e(asset(Storage::url($product->image))); ?>" alt=""></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Point Of Sale\POS\resources\views/products/index.blade.php ENDPATH**/ ?>