...
@section('content-header', 'Quick Purchase')
...
<div class="">
    <div class="">
        <div class="card text-primary" style="border-top: 3px solid;">
            <div class="card-body">
                <form action="{{ route('purchase.storePurchase') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="form-group col-6" style="display: flex; align-items:center;">
                            <label for="supplier">Supplier</label>
                            <div class="w-100 mb-0">
                                <select name="supplier_id" class="formInput @error('supplier') is-invalid @enderror" id="supplier">
                        ...
                        <div class="form-group col-6" style="display: flex; align-items:center;">
                            ...
                            <input type="date" name="purchaseDate" class="formInput @error('date') is-invalid @enderror" id="date" placeholder="Date" style="margin-left:3px">
                            @error('date')
                    ...
                    <div class="row">
                        <div class="form-group col-6" style="display: flex; align-items:center;">
                            ...
                            <input type="text" name="barcode" class="form-control @error('barcode') is-invalid @enderror w-75 mx-auto" id="barcode" placeholder="barcode" value="" required>
                            @error('barcode')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group col-6" style="display: flex; align-items:center;">
                            ...
                            <select name="category" class="form-control @error('category') is-invalid @enderror w-75 mx-auto" id="category" required>
                    ...
                    <div class="row d-flex">
                        <div class="btn-group col-8" style="display: flex; align-items:center;">
                            ...
                            <select name="category" class="formInput @error('name') is-invalid @enderror" id="add_row" style="margin-right:0px">
...
<script>
    ...
    $("#add_row").on('change', function() {
        ...
        var url = '{{ route("product.getproduct") }}';
        // Make the Ajax call
        $.ajax({
            type: 'GET',
            url: url,
            ...
            success: function(response) {
                    ...
                    <div class="modal-body">\
                        <div class="row">\
                            <div class="form-group col-4">\
                                ...
                                <input type="number" name="kg[]" step="0.2" class="form-control @error("kg") is-invalid @enderror" value="' + product.kg + '" id="kg' +
                        product.id +
                        '" placeholder="KG" value=") }}">\
                            </div>\
                            <div class="form-group col-4">\
                                <label for="bag">Total Bags</label>\
                                <input type="text" name="bagQty[]" class="form-control @error("quantity") is-invalid @enderror" id="bag' +
                        product.id +
                        ...
                        <div class="row">\
                            <div class="form-group col-4">\
                                ...
                                <input type="number" name="short[]" step="0.2" class="form-control @error("short") is-invalid @enderror" id="short' +
                        product.id +
                        ...
                        <div class="form-group col-4">\
                                ...
                                <input type="text" name="netWeight[]" class="form-control @error("netWeight") is-invalid @enderror" id="netWeight' +
                        product.id +
                        '" placeholder="Net Weight" value="">\
                            </div>\
                            <div class="form-group col-4">\
                            <label for="kgDiscount">Discount / Kg</label>\
                            <input type="text" name="kgDiscount[]" class="form-control @error('
                        kgDiscount ') is-invalid @enderror" id="kgDiscount' +
                        product.id +
                        ...
                        <div class="form-group col-6">\
                                ...
                                <input type="text" name="unit_cost[]" class="form-control @error("netWeight") is-invalid @enderror" id="unitCost' +
                        product.id +
                        '" placeholder="00" value="">\
                            </div>\
                            <div class="form-group col-6">\
                            <label for="barcode">Purchase Price (with out shorts)</label>\
                            <input type="text" name="grossTotal[]" class="form-control @error("grossTotal") is-invalid @enderror" id="grossTotal' +
                ...
                <td class=""><input type="text" class="w-75 text-center tax @error("Tax") is-invalid @enderror" id="tax' + product.id + '" name="tax[]" style="min-width:70px" placeholder="00" value="0"></td>\
                <td class="sale_td"><input type="text" class="w-75 text-center profit @error("profit") is-invalid @enderror" id="profit' + product.id + '" name="profit[]" style="min-width:70px" place_holder="00" value="0"></td>\
