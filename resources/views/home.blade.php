      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group w-75 mx-auto text-center fa-2x">
            ...
            <input type="text" name="balance" value="0" class="form-control @error('balance') is-invalid @enderror" id="balance" placeholder="00">
          </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-6">
        ...
        <div class="small-box bg-success">
          <div class="inner">
            <h5 id="income">{{config('settings.currency_symbol')}} {{$income}}</h5>
            <p>Income</p>
          </div>
          <div class="icon">
      ...
      <div class="col-lg-4 col-6">
        ...
        <div class="small-box bg-gradient-secondary">
          <div class="inner">
            <h5>{{config('settings.currency_symbol')}} {{number_format($income_today, 2)}}</h5>
            <p>Income Today</p>
          </div>
          <div class="icon">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-6">
        ...
        <div class="small-box bg-gradient-purple">
          <div class="inner">
            <h5 id="opening_amount">{{config('settings.currency_symbol')}} {{$income-$expenses, 2}}</h5>
      ...
      <div class="col-lg-4 col-6">
        ...
        <div class="small-box bg-danger">
          <div class="inner">
            <h5>{{config('settings.currency_symbol')}} {{number_format(($purchaseAmount+$expenses),2)}}</h5>
            <p>Balance Debited</p>
          </div>
          <div class="icon">
            <i class="ion ion-pie-graph"></i>
...
<table class="table table-sm border text-center" id="dataTable">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td id="address">{{ $order->getCustomerAddress() }}</td>
      ...
      <td>
        @if($order->receivedAmount() == 0 &&( $payment->amount + $payment->discount) > 0)
        <span class="badge badge-danger text-white">Not Paid</span>
        @elseif(($payment->dues) > 0 && ($payment->amount)>0)
        <span class="badge badge-warning text-white">Partial</span>
        @elseif($payment->amount > ($payment->amount + $payment->dues))
