...
<div class="invoice p-3" id="printThis">
    ...
    <div class="row invoice-info text-center">
        ...
        <div class="col-sm-4 invoice-col">
            ...
            <br>
            <b>Payment Due:</b> {{$payment->date}}<br>
            <b>Account:</b> {{$payment->paymentMethod}}
        </div>
        <!-- /.col -->
    </div>
    <!-- /.row -->
            ...
            <table class="table table-sm" style="border-style:dashed">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $order->kgs !==null?$order->kgs:'00'}}</td>
                        <td>{{ $order->shorts }}</td>
                        <td>Rs {{ number_format($order->kg_price !==null?$order->kg_price:00, 2) }}</td>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>Rs {{$payment->amount + $payment->dues + $payment->discount}}</td>
                        </tr>
                        <tr>
                            <th>Total Discount</th>
                            <td>Rs <span id="dues">{{$payment->discount}}</span></td>
                        </tr>
                        <tr>
                            <th>Paid Amount</th>
                        ...
                        <tr>
                            <th>Dues</th>
                            <td>Rs <span id="dues">{{$payment->dues}}</span></td>
                        </tr>
                        <tr>
                            <th>Payment Type</th>
